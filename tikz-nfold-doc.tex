...
\end{itemize}
In the following example we see how \verb|\pgfoffsetpath{..}{0pt}| reproduces the input path (rendered in black) and how \verb|\pgfoffsetpathfraction{..}{8pt}{0}| differs from the former.
\begin{tkzexample}[latex=4cm]
\begin{tikzpicture}[line join=bevel]
  ...
  \pgfsetstrokeopacity{.7} \color{red} \pgfusepathqstroke
\end{tikzpicture}
\end{tkzexample}
