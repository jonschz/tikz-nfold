...
% ------------
%
% - diff against prior version for minimal modification
%
% Future
% ------
          ...
          \else%
            ...
            \else%
              \ifx#1\pgfsyssoftpath@closepathtoken%
                \let\pgf@nfold@last@closepath@from\previous@pt%
...
\def\pgf@nfold@parselineto#1#2{%
  % because parser@moveup has not been called yet, the current end is still stored in next@last
