...
\def\pgf@nfold@@parsesoftpath#1#2#3{%
  ...
  \else%
    \ifx#1\pgfsyssoftpath@movetotoken%
      ...
      \else%
        \def\pgf@nfold@macrotoadd{\pgf@nfold@processmoveto{#2}{#3}}%
        \pgf@nfold@addmacro\pgf@cur@conn@subpath%
    ...
    \else%
      \ifx#1\pgfsyssoftpath@linetotoken%
        \def\pgf@nfold@macrotoadd{\pgf@nfold@processlineto{#2}{#3}}%
        \pgf@nfold@addmacro\pgf@cur@conn@subpath%
      \else%
        ...
        \else%
          ...
          \else%
            \ifx#1\pgfsyssoftpath@curvetotoken%
              \edef\pgf@nfold@macrotoadd{\noexpand\pgf@nfold@processcurveto\pgf@nfold@parser@supporta\pgf@nfold@parser@supportb{#2}{#3}}%
              \pgf@nfold@addmacro\pgf@cur@conn@subpath%
            \else%
              \ifx#1\pgfsyssoftpath@closepathtoken%
                \let\pgf@nfold@last@closepath@from\pgf@nfold@parser@previous@pt%
                \def\pgf@nfold@macrotoadd{\pgf@nfold@processclosepath{#2}{#3}}%
                \pgf@nfold@addmacro\pgf@cur@conn@subpath%
              \else%
                ...
                \else%
                  \ifx#1\pgfsyssoftpath@rectsizetoken%
                    \edef\pgf@nfold@macrotoadd{\noexpand\pgf@nfold@processrect\pgf@nfold@parser@rectcorner{#2}{#3}}%
                    \pgf@nfold@addmacro\pgf@cur@conn@subpath%
                  \else%
...
\def\pgf@nfold@processrect#1#2#3#4{%
  \pgf@nfold@processmoveto{#1}{#2}%
  \pgf@xc=#1\relax
  \pgf@yc=#2\relax
  \pgf@xd=#3\relax
  \pgf@yd=#4\relax
  ...
  \expandafter\pgf@nfold@processlineto\pgf@temp%
  ...
  \edef\pgf@temp{{\the\pgf@xc}{\the\pgf@yc}}%
  \expandafter\pgf@nfold@processlineto\pgf@temp%
  \edef\pgf@marshal{\noexpand\pgf@nfold@processmoveto{\the\pgf@xc}{\the\pgf@yc}}%
  \pgf@marshal%
}
