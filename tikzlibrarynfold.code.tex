...
% This stores whether the currently processed connected segment is the final one on this path
\newif\ifpgf@nfold@lastconnsegment
  ...
  \else%
    \ifx#1\pgfsyssoftpath@movetotoken%
      ...
      \else%
        ...
        \pgf@nfold@addmacro\pgf@cur@conn@segment%
        \pgf@nfold@lastconnsegmentfalse%
