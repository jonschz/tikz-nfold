...
In this example, the nfold preparation code must be injected into \verb|\pgf@path@check@proper|.
{
\makeatletter
...
The second example has some slightly incorrect behaviour, but I don't expect many cases where this would be relevant.
\begin{tikzpicture}
