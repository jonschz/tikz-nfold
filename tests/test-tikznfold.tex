...
\begin{tikzpicture}
  \draw[nfolder={red, yellow, green, blue}, arrows=->] (0,0) -- (1,0) to[out=0, in=270] (2,1);
\end{tikzpicture}
\begin{tikzpicture}
  \draw[dashed, nfolder={red, green, blue}] (0,0) -- (1,0) -- (1,1) -- cycle;
\end{tikzpicture}
\begin{tikzpicture}[rotate=10]
  \draw[dashed, nfolder={red, blue}, fill=yellow, fill opacity=.5] (0,0) -- (1,0) -- (1,1) -- cycle;
\end{tikzpicture}

\subsection{offset}
\begin{tikzpicture}
  \draw[offset=1mm] (0,0) node[left] {a} to[out=10, in=170] (1,0) node[right] {b};
\end{tikzpicture}
...
\subsection{nfolder + offset}
Credits to Qrrbrbirlbel\\
\begin{tikzcd}
A \ar[r, bend left, offset=-2mm] & B \ar[d, nfolder={rightarrow, -, help lines, Leftrightarrow}] \\
